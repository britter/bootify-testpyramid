...
import com.github.britter.bootifytestpyramid.domain.OrderGateway;
    ...
    class GetAll {
        ...
        void should_return_all_orders() throws Exception {
            ...
            mvc.perform(get("/orders"))
                    ...
                    .andExpect(OrderResponseMatchers.smallOrderFieldsAtIndex(0))
                    .andExpect(OrderResponseMatchers.completeKitchenFieldsAtIndex(1));
        }
    }
    ...
    class GetOne {
        ...
        void should_return_order_by_id() throws Exception {
            ...
            mvc.perform(get("/orders/15"))
                    .andExpect(status().isOk())
                    .andExpect(OrderResponseMatchers.bigOrderFields());
        }
