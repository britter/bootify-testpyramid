...
public final class OrderItemTemplates {
    ...
    public static OrderItem couches(int quanity) {
        return new OrderItem(1, "Couch", "A cozzy couch", new Weight(35), Price.germanPrice(289.99), quanity);
    }
    ...
    public static OrderItem closets(int quanity) {
        return new OrderItem(1, "Closet", "A closet to put your stuff into", new Weight(300), Price.germanPrice(499.99), quanity);
    }
    ...
    public static OrderItem tables(int quantity) {
        return new OrderItem(1, "Table", "A nice white kitchen table", new Weight(20), Price.germanPrice(79.99), quantity);
    }
    ...
    public static OrderItem beds(int quantity) {
        return new OrderItem(1, "Bed", "A king sized bed", new Weight(200), Price.germanPrice(499.99), quantity);
    }
    ...
    public static OrderItem chairs(int quantity) {
        return new OrderItem(1, "Chair", "A kitchen chair", new Weight(10), Price.germanPrice(29.99), quantity);
    }
